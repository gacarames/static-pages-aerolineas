...
$(document).ready(function(){
	...
	if($.browser.opera){
		$(".nav ul").css("margin-top", "28px");//opera fix for margin top
	...
	if($.browser.msie){
	   ...
	   var dTop = $('.nav li:first').offset().top-4;
	...
	$(".nav > li").hover(function(){
		...
		$('#box').stop().animate({left: position},{duration:speed, easing: style});	//animating lava lamp
